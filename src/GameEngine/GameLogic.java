...
public class GameLogic {
    ...
    // checkIfScored() setz den Status von Steinen, die sich auf der gegenüberliegend Grundlinie befinden uf Locked. 
    //Diese werden schwarz und können nicht mehr bwegt werden.
    public void checkIfScored(){
        for(Tile tile: getTiles()){
            if(getTiles().indexOf(tile) % 9 == 0 && tile.getStatus() == TileStatus.PLAYER2){
                tile.setStatus(TileStatus.LOCKED);
            }else if((getTiles().indexOf(tile) + 1) % 9 == 0 && tile.getStatus() == TileStatus.PLAYER1){
                tile.setStatus(TileStatus.LOCKED);
            }
    ...
    // step() lauft dann einmal durch die Logik des Spiels. In ihr sind alle möglichen Spielzüge definiert.
    public void step() throws IndexOutOfBoundsException{
        ...
        for(Tile tile: getTiles()){
            if(getInput().getX() > tile.getX() * getTileSize() && getInput().getX() < tile.getX() * getTileSize() + getTileSize()){
                if(getInput().getY() > tile.getY() * getTileSize() && getInput().getY() < tile.getY() * getTileSize() + getTileSize()){
                    ...
                    }else if(tile.getStatus() == TileStatus.PLAYER2 && !movingTiles){
                        setSelectedTile(tile);
                        setMovingTiles(true);
                        tile.setStatus(TileStatus.PLAYER2SELECTED);
                        
                    }else if(tile.getStatus() == TileStatus.EMPTY && isMovingTiles()){
                        if((tiles.indexOf(selectedTile) - tiles.indexOf(tile) <= 10 && tiles.indexOf(selectedTile) - tiles.indexOf(tile) >= 8) || (tiles.indexOf(tile) - tiles.indexOf(selectedTile) >= 8 && tiles.indexOf(tile) - tiles.indexOf(selectedTile) <= 10) || (tiles.indexOf(tile) - tiles.indexOf(selectedTile) >= 8 && tiles.indexOf(tile) - tiles.indexOf(selectedTile) <= 10) || (tiles.indexOf(selectedTile) - tiles.indexOf(tile) == 1 || tiles.indexOf(selectedTile) - tiles.indexOf(tile) == -1)){
                    ...
                    }else if(tile.getStatus() == TileStatus.PLAYER1 && movingTiles){
                        if(selectedTile.getStatus() == TileStatus.PLAYER1SELECTED){
                            if(tiles.indexOf(tile) % 9 != 0){
                                if(tiles.indexOf(selectedTile) - tiles.indexOf(tile) == 8 && tiles.get(tiles.indexOf(tile) - 8).getStatus() == TileStatus.EMPTY){
                                    tiles.get(tiles.indexOf(tile) - 8).setStatus(TileStatus.PLAYER1);
                                    selectedTile.setStatus(TileStatus.EMPTY);
                                
                                }else if(tiles.indexOf(tile) - tiles.indexOf(selectedTile) == 10 && tiles.get(tiles.indexOf(tile) + 10).getStatus() == TileStatus.EMPTY){
                                    tiles.get(tiles.indexOf(tile) + 10).setStatus(TileStatus.PLAYER1);
                                    selectedTile.setStatus(TileStatus.EMPTY);
                                
                                }else if(tiles.indexOf(tile) - tiles.indexOf(selectedTile) == -10 && tiles.get(tiles.indexOf(tile) - 10).getStatus() == TileStatus.EMPTY){
                                    tiles.get(tiles.indexOf(tile) - 10).setStatus(TileStatus.PLAYER1);
                                    selectedTile.setStatus(TileStatus.EMPTY);
                                }else if(tiles.indexOf(selectedTile) - tiles.indexOf(tile) == -8 && tiles.get(tiles.indexOf(tile) + 8).getStatus() == TileStatus.EMPTY){
                                    tiles.get(tiles.indexOf(tile) + 8).setStatus(TileStatus.PLAYER1);
                                    selectedTile.setStatus(TileStatus.EMPTY);
                                }else{
                                    selectedTile.setStatus(TileStatus.PLAYER1);
                            ...
                            if(tiles.indexOf(tile) % 9 != 0){
                                if(tiles.indexOf(selectedTile) - tiles.indexOf(tile) == 8 && tiles.get(tiles.indexOf(tile) - 8).getStatus() == TileStatus.EMPTY){
                                    tiles.get(tiles.indexOf(tile) - 8).setStatus(TileStatus.PLAYER2);
                                    tile.setStatus(TileStatus.EMPTY);
                                    selectedTile.setStatus(TileStatus.EMPTY);
                                
                                }else if(tiles.indexOf(tile) - tiles.indexOf(selectedTile) == 10 && tiles.get(tiles.indexOf(tile) + 10).getStatus() == TileStatus.EMPTY){
                                    tiles.get(tiles.indexOf(tile) + 10).setStatus(TileStatus.PLAYER2);
                                    tile.setStatus(TileStatus.EMPTY);
                                    selectedTile.setStatus(TileStatus.EMPTY);
    ...
    /**
     * @param movingTiles the movingTiles to set
     */
