...
public class View  extends JPanel{
    ...
    // update() führt step() einmal aus und zeichnet danach das veränderte Spielfeld neu.
    public void update(){
        getGameLogic().step();
        repaint();
    }
    ...
    public void paint(Graphics g){
        for(Tile tile:getGameLogic().getTiles()){
            ...
            if(tile.getStatus() == TileStatus.PLAYER1){
                ...
                g.fillRect(tile.getX()*GameLogic.getTileSize(), tile.getY()*GameLogic.getTileSize(), GameLogic.getTileSize(), GameLogic.getTileSize());
            }
            ...
            if(tile.getStatus() == TileStatus.PLAYER1SELECTED){
                ...
                g.fillRect(tile.getX()*GameLogic.getTileSize(), tile.getY()*GameLogic.getTileSize()+1, GameLogic.getTileSize(), GameLogic.getTileSize());
            }
            ...
            g.setColor(Color.BLACK);
            g.drawRect(tile.getX()*GameLogic.getTileSize(), tile.getY()*GameLogic.getTileSize(), GameLogic.getTileSize(), GameLogic.getTileSize());           
        }
    }
